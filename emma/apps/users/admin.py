...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'first_name', 'mother_last_name',
    ...
    fieldsets = (
        ...
        ('Personal info', {
            'fields': ('first_name', 'father_last_name', 'mother_last_name')
        }),
        ('Permissions', {
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'first_name', 'father_last_name', 'mother_last_name',
